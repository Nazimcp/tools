...
echo "Github:Nazimcp"
echo "Instagram:nazimcp7"
echo "Youtube:Cyber_Black"
echo "Facebook:NazimNazim"
echo "Whatsapp:+91 7025604804"
...
sleep 1
echo "WE WIL HELP YOU FOR ANY TECHNICAL ISSUE";
sleep 1
echo "YOU CAN ASK YOUR QUSTIONS ON INSTAGRAM [Time 06:00AM TO 06:00PM]";
sleep 1
echo "PLEASE SUBSCRIBE OUR CHANNEL";
sleep 1
echo "IN OUR CHANNEL WE WILL UPLAOD THE REAL TYPE OF HACKING AND SOME GAME HACKING TOTORIAL";
sleep 1
echo "IF YOU ARE INTRESTED IN WEB DEVELOPMENT,APP DEVELOPMENT,TERMUX TOOL DEVELOPMENT AND WEB DESINGING YOU CAN SAY TO ME IN THE INSTAGRAM OR ANY OTHER SOSCIAL MEDIA";
sleep 1
